...
--
-- Host: localhost    Database: DormitoryManageSystem
-- ------------------------------------------------------
...
CREATE TABLE `assignments` (
  ...
  CONSTRAINT `assignments_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rooms` VALUES (1,'400',0,0),(2,'400',0,0),(10002,'400',0,0),(10004,'471',2,0),(10005,'471',2,0),(10006,'471',2,0);
...
-- Dump completed on 2024-07-24  1:22:24
